...
public class Main {
    ...
    void test() {
        ...
        Assertions.assertEquals(120, solution(N, buildTime, rules, targetBuilding));
    }
    ...
    void test2() {
        ...
        Assertions.assertEquals(39, solution(N, buildTime, rules, targetBuilding));
    }
    ...
    void test3() {
        ...
        Assertions.assertEquals(212, solution(N, buildTime, rules, targetBuilding));
    }
    /**
...
//            }
    ...
    private List<Integer> getEdgePoints(Queue<Integer> queue) {
        List<Integer> edgeList = new ArrayList<>(queue.size());
        while(!queue.isEmpty()) {
    ...
    private int getMaxBuildTime(List<Integer> zeroIndegrees, int[] buildTimes) {
        int maxBuildTime = 0;
        for (int idx : zeroIndegrees) {
            maxBuildTime = Math.max(buildTimes[idx], maxBuildTime);
        }
        return maxBuildTime;
    }
